...
- explicit coding-agent rule/Skill namespaces;
- Noema consumer manifest;
- compact project principles;
...
- This repository is cumulative across relevant 4Geeks company milestones.
- 4Geeks rubric compliance precedes optional engineering extensions.
- Complexity must be technically justified; prefer minimum sufficient architecture.
- Solve Nexova-specific problems first; abstract only after evidence of reuse.
- Noema provides coordination/conformance; it does not own Nexova domain/runtime state.
- Historical Nexova product/agent ideas are candidates, not a frozen roadmap.
